<html lang="en">
   ...
   <body>
      <div id="wrapper">
         <div id="main">
            <div class="inner">
               <p id="text02"><mark>This textbook archive will be continuously updated.</mark></p>
               <p id="text01"><a href="https://bit.ly/3LeS0r7">M. Sullivan Precalculus 11th edition</a> (added 09/13/2022 at 10:18 PM)</p>
               <div id="credits" class="icc-credits"><span><a href="https://sk1lark.github.io/">Link to Github</a></span></div>
            </div>
         </div>
      </div>
      <script>(function() {
         ...
         ,$body = document.body,$inner = $('.inner'),client = (function() {
             var o = {
                 browser: 'other',browserVersion: 0,os: 'other',osVersion: 0,mobile: false,canUse: null,flags: {
                     lsdUnits: false,
                 }
                 ,
             }
         ...
         if (client.os == 'android') {
             ...
             if (client.osVersion <= 11)(function() {
                 sheet.insertRule('body.ios-focus-fix::before {
                 }
                 ', 0);
                 rule = sheet.cssRules[0];
